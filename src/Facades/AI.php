 ...
 * @method static \AIMatchFun\LaravelAI\Services\AIService previewMessages(array $messages)
 * @method static \AIMatchFun\LaravelAI\Services\AIService temperature(AICreativity $level)
